...
console.log('✌️what_to_expect --->', what_to_expect);
  ...
  return (
    <div className="mx-4 sm:mx-10 md:mx-20 lg:mx-32">
      ...
      <div className="relative">
        <img src={imageUrl} alt="Overlay" className="w-full h-[340px]" />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-100 p-4">
          <ul className="flex ml-20">
            ...
            <li className="mr-10">Instructor</li>
            <li>Reviews</li>
          </ul>
          <div className="mt-10">
            ...
            <h2 className="mt-5 text-xl ml-10">
              ...
              <div>
              {removeHtmlTags(what_to_expect.html_content)}
              </div>
            <br />
        ...
        <div className="bg-gray-100 w-[420px] h-[250px]  p-4 ml-[90px] mt-[-80px] z-10">
          ...
          <span className="text-3xl">
            <b>{course.fee.amount} {course.fee.currency? '₹':null}</b>
          </span>
          ...
          <ul>
            <li className="mt-2">on_demand_videos:{course.inclusions.on_demand_videos}</li>
            <li className="mt-2">live_qa_sessions:{course.inclusions.live_qa_sessions ? 'yes':'no'}</li>
            <li className="mt-2">whatsapp_community:{course.inclusions.whatsapp_community ? 'yes':'no'}</li>
          </ul>
          <button class="flex bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-10 ml-20 mt-4 rounded-full items-center ">
  Register Now
</button>
        </div>
      </div>
      <div>
        <h3 className="mt-10 text-2xl ml-10">About the Instructor</h3>
        <div className="grid grid-cols-2 gap-4 mt-4 ">
          {/* Content for the grid columns */}
          <div className="bg-gray-100 p-4">
            <div className="flex">
              <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center "></div>
              <p className="ml-10">
  ...
  <div className="w-10 h-10 bg-blue-500 rounded-full flex  justify-center mr-3 ">
      <span className="text-white font-bold">A</span> {/* Replace with the initial of the author */}
    </div>
    <span className="font-semibold">
      {testimonial?.reviewer_name}<br/>
      <span>{testimonial?.reviewer_designation}</span>
    </span>
