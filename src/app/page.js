...
console.log('✌️what_to_expect --->', what_to_expect);
  ...
  {course.title.slice(0, 37)}<br/>
  <span className="ml-2">
    {course.title.slice(37,64)}<br/>
    </span>
    <span className="ml-10">

    {course.title.slice(64)}
    </span>
</span>
        ...
        <div className="bg-gray-100 p-4">
          ...
          <div className="mt-10">
            ...
            <h2 className="mt-5 text-xl ml-10">
              ...
              <div className="ml-6">
              {removeHtmlTags(what_to_expect.html_content.slice(0,42))}<br/>
              {removeHtmlTags(what_to_expect.html_content.slice(42 ,71))}<br/>
              {removeHtmlTags(what_to_expect.html_content.slice(71))}<br/>
